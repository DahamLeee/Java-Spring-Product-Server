...
<body>
	<div class="container">
      <%@ include file="../navbar.jsp" %>
		...
		<div class="col-lg" align="center" id="m_form">
			<form id="memberform" method="post" action="${root}/user/modify">
				<div class="form-group" align="left">
					<label for="">아이디</label>
					<input type="text" class="form-control" id="" name="" placeholder="" value="${userinfo.user_id}" disabled>
					<input type="hidden" class="form-control" id="m_id" name="m_id" placeholder="" value="${userinfo.user_id}">
				</div>
				<div class="form-group" align="left">
